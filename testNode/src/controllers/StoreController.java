...
public class StoreController implements Initializable {
	...
	public void handleNext(ActionEvent t) throws IOException{
		Parent root = FXMLLoader.load(getClass().getResource("/FXML/Branch_instruction.fxml"));
	...
	public void handlePrev(ActionEvent t) throws IOException{
		Parent root = FXMLLoader.load(getClass().getResource("/FXML/Load_instruction.fxml"));
		Stage stage = (Stage) next.getScene().getWindow();
		Scene scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
